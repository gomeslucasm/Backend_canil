...
class AnimalSerializer(serializers.ModelSerializer):
    ...
    animal_photo = AnimalPhotoSerializer(
        many=True, read_only=True, required=False)
    location_display = serializers.CharField(
        source='get_location_display', required=False)
    size_display = serializers.CharField(
        source='get_size_display', required=False)
    sex_display = serializers.CharField(
        source='get_sex_display', required=False)
    animal_type_display = serializers.CharField(
        source='get_animal_type_display', required=False)
    ...
    class Meta:
        ...
        fields = [
            ...
            'size_display', 'age', 'responsible_volunteer',
        ]
